 ...
 * @author Thishan
 */
@WebServlet(name = "Postquestservelet", urlPatterns = {"/Postquest"})
public class Postquestservelet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Postquestservelet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Postquestservelet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession session = request.getSession();
         ...
         try (PrintWriter out = response.getWriter()) {
             ...
             String site=new String("view/Forum/Learner_Forum.jsp");
