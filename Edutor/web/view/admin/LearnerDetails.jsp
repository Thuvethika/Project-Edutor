<%-- 
    Document   : LearnerDetails
    Created on : 04-Jan-2022, 17:46:10
    Author     : thuve
--%>
    ...
    <center>
      <div class="d-flex justify-content-center">
        ...
        <div class="tabContents" id="servicesContainer">
            ...
            <center>
                 <h1 style="text-align:center"> Learner Details </h1><br>
              ...
              <%    try 
        {
          //  AnnouncementDao announcement = new AnnouncementDaoImpl();
            ...
            String sql2 = "SELECT firstname, email FROM learner";
           ...
           <form action="<%=request.getContextPath()%>/AdminManageUser?email3=<%=rs2.getString("email") %> " method="POST">
                 
                       <tr>
                                    <td><%= rs2.getString("firstname") %> </td>
                                    <td><%= rs2.getString("email") %></td>
                                  
                                    <td> <button  class="dropbtn3" name="button3"  value="view1" > Manage</button></td>
                                </tr>   </form>
                      <%
