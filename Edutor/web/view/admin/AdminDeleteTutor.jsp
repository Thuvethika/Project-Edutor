<%-- 
    Document   : AdminDeleteTutor
    Created on : 01-Dec-2021, 00:25:10
    Author     : thuve
--%>
    ...
    <center>
      <div class="d-flex justify-content-center">
        ...
        <div class="tabContents" id="servicesContainer">
          <h1>Manage Tutor</h1><br>
          <div class="enrolbox">
           
  <br>
  <br>
  <div>
        <form action="<%=request.getContextPath()%>/AdminDeleteTutor" method="POST"> 
       <% 
      try{
           ...
           DeleteUser user = new DeleteUser();
            ...
            Class.forName("com.mysql.jdbc.Driver");  
                  Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/edutor","root","");
                   String sql="SELECT firstname,lastname,address,gender,dob,phoneno FROM tutor where email='"+ user.getEmail()+"'";            
   ...
   <input type="date" name="dob" value="<%= rs.getString("dob") %>" ><br/><br/>
    ...
    <a href="reset"><button type="reset" class="del-btn" name="button1" value="reset">Reset</button></a>
    <a href="signup"><button type="submit" class="del-btn" name="button1" value="update" >Save</button></a>
    
    <button  class="del-btn" name="button1" value="delete"  >Delete</button>
        </form>
  </div>
  </div>
