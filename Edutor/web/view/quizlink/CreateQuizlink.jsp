<%-- 
    Document   : CreateQuizlink
    Created on : 06-Jan-2022, 11:09:10
    Author     : thuve
--%>
...
<head>
    ...
    <title>Create Quiz link for Tutors</title>
    <link rel="stylesheet" href="QuizLink_Tutor.css" />
  ...
  <body>
    ...
    <div class="overlay hidden" id="popWindow">
      <div class="ad-form hidden">
        ...
        <img src="../Images/ED.png" alt="logos" width="150" height="150"><br />  </a>
        <div class="row1">
    ...
    <div class="main"> 
      <br><h1 style="text-align:center"> Upload Quiz Links </h1><br>
			<center>
    <form action="<%=request.getContextPath()%>/quizlink" method="POST">                
      <div class="ancreate">
       <center>
        <label for="Topic">Topic</label><br/>
        <input type="text" name = "topic" size="100"><br /><br/>

        <label for="datepick">Date</label><br/>		
        <input type="date" name = "date"> <br/><br/>

        <label for="Details"> Link</label>
        <br>
        <textarea id="txt" cols="40"  name = "quizlink" placeholder="Type your details here...">
          
          </textarea>    
      </center>

      
      <button class="publish-btn" style = "position:relative;" onclick="window.location.href='#'">
        Publish</button>	
