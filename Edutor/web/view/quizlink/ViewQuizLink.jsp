<%-- 
    Document   : ViewQuizLink
    Created on : 06-Jan-2022, 11:19:16
    Author     : thuve
--%>

<%@page import="Model.QuizLink"%>
...
<head>
    ...
    <title>Quiz Link for Tutors</title>
    <link rel="stylesheet" href="QuizLink_Tutors.css" />
  ...
  <body>
    ...
    <div class="main"> 
      <br><h1 style="text-align:center">Quiz Links </h1><br>
			<center>
         <div class="ancreate">
     ...
     int classid = ((Integer) session2.getAttribute("classid"));
            ...
            String sql2 = "SELECT topic,date,quizlink,quizid FROM quizlinks where email='" + L.getEmail() + "' && classid='" + L.getClassid() + "' ";
            ...
            if(rs.next()== false)
              ...
              else
              {
               ...
               %>
              <form action="<%=request.getContextPath()%>/ManageQuizLinks?quizid=<%=rs.getString("quizid") %>" method="POST">
               <table id="announcement_t">
                      ...
                      <% 
                       do{  %> <tr>
                                    ...
                                    <td><%= rs.getString("quizlink") %> </td>
                                    <td><button  class="confirm-btn" name="button" value="manage"> Delete</button> </td>
                                </tr> <%
...
<button class="confirm-btn" onclick="window.location.href= 'CreateQuizlink.jsp'">Create</button>
                        </center>
