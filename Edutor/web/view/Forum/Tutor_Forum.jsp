				  ...
				  <div class="main-popup">
					<div class="popup-content">
					  <span class="close-btn">&times;</span>
                                            <form action="<%=request.getContextPath()%>/Postquest2" method="POST"> 
					  ...
					  <button type="submit" class="save" >Publish</button>
                                          ...
                                          <center>
                           <form action="<%=request.getContextPath()%>/Discussforum2" method="POST"> 
