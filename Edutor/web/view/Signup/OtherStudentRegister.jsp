<%-- 
    Document   : OtherStudentRegister
    Created on : 02-Oct-2021, 12:47:12
    Author     : thuve
--%>
...
<body>
	<div class="topNavBar row">
		...
		<div class="main">
		<br/>		
		<form ENCTYPE="multipart/form-data" action="<%=request.getContextPath()%>/OtherStudentRegister" method="POST">
		<center>
		...
		<input type="text" name="workplace" size="40" ><br /><br/>
		...
		<input type="password" name="password" id="psw" name="psw" size="40" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required><br /><br/>
