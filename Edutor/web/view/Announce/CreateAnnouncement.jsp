...
<head>
    ...
    <title>Create Announcements for Tutors</title>
    ...
    <form action="<%=request.getContextPath()%>/CreateAnnouncement" method="POST">                
      <div class="ancreate">
       <center>
        ...
        <label for="Details"> Message or Link</label>
        <br>
        <textarea id="txt" cols="80"  name = "details" placeholder="Type your details here...">
