...
<html lang="en">
  ...
  />
	...
	<link rel="stylesheet" type="text/css" href="../finalnavbar/TopNavBartest.css">
    ...
    <div class="topNavBar row">
      ...
      <div id="mySidenav" class="sidenav">
        ...
        <div class="profile-img">
          ...
          <a href="../Edit_profile/edit.jsp"
            ><img
              ...
              height="50px"
              style="position: relative; left: 50px; margin-top: -250px"
          /></a>
        ...
        <img
          src="../Images/ED.png"
          height="150"
          style="position: relative; left: 40px; margin-bottom: 0px "
        />
      </div>
